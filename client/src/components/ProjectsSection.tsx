...
function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="bg-white border border-[oklch(0.92_0.06_350)] overflow-hidden hover:shadow-lg transition-shadow">
      <div className="p-6">
        {/* Header */}
        <div className="flex items-start justify-between mb-4">
          ...
          <button
            ...
            className="text-[oklch(0.88_0.15_350)] hover:text-[oklch(0.78_0.20_350)] transition"
          >
        ...
        <div className="photo-placeholder w-full h-75 mb-4 overflow-hidden rounded-md bg-[oklch(0.95_0.06_350)]">
          <img
            src={project.img || PLACEHOLDER_IMAGE}
        ...
        {/* Expanded Content */}
        {isExpanded && (
          <div className="mt-6 space-y-6 border-t border-[oklch(0.92_0.06_350)] pt-6">
            {/* Audit */}
            <div>
